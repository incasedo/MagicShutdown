...
#define OLEDATEEX_FIRST					0
#define OLEDATEEX_SECOND					1
#define OLEDATEEX_THIRD					2
#define OLEDATEEX_FOURTH					3
#define OLEDATEEX_LAST						4
...
public:
	...
	CString GetSystemShortDateFormat();
	CString GetSystemLongDateFormat();

	CString GetDayOfWeekName(int iDay);
	CString GetMonthName(int iMonth);
	CString ConvertVBFormatToCFormat(LPCTSTR lpszInput);

	virtual BOOL GetDayInMonth(int iMonth, int iYear, int iWhichDay, int iDayOfWeek);
	virtual BOOL GetLastDayOfWeekInMonth(int iMonth, int iYear, int iDayType);
	virtual BOOL GetDayOfWeekInMonth(int iMonth, int iYear, int iCount, int iDayType);
	virtual BOOL GetBuiltInValue(int iType, int iYear);

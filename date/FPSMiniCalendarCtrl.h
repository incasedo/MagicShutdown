...
// custom messages
#define WM_FPSMINICLNDR_VIEWCHANGE		WM_USER+1
...
#define FMC_DEFAULT_FONT_SIZE		10
#define FMC_DEFAULT_FONT_SIZE_640	9
#define FMC_DEFAULT_FONT_SIZE_800	10
#define FMC_DEFAULT_FONT_SIZE_1024	12
#define FMC_DEFAULT_FONT_SIZE_1280	14
#define FMC_DEFAULT_MIN_FONT_SIZE	5
...
public:
	...
	void SetSpecialDaysCallback(funcSPECIALDATE pValue, DWORD dwParm = NULL);
	...
	void SetSpecialDaysColor(COLORREF Color) {m_cSpecialDaysColor = Color;}

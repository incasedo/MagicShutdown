...
BOOL COleDateTimeEx::EvaluateInputTextDate(LPCTSTR lpszInput, COleDateTime &dt)
{
	...
	if (_stricmp(strInput, "today") == 0 || _stricmp(strInput, "now") == 0)
	{
		bReturn = TRUE;
	}
	else if (_stricmp(strInput, "yesterday") == 0)
	{
		dt -= 1;
		bReturn = TRUE;
	}
	else if (_stricmp(strInput, "day before yesterday") == 0)
	{
		dt -= 2;
		bReturn = TRUE;
	}
	else if (_stricmp(strInput, "tomorrow") == 0)
	{
		dt += 1;
		bReturn = TRUE;
	}
	else if (_stricmp(strInput, "day after tomorrow") == 0)
	{
		dt += 2;
		bReturn = TRUE;
	}
	else if (_stricmp(strInput, "next week") == 0)
	{
		dt += 7;
		bReturn = TRUE;
	}
	else if (_stricmp(strInput, "last week") == 0)
	{
		dt -= 7;
		bReturn = TRUE;
	}
	else if (_stricmp(strInput, "christmas") == 0 || _stricmp(strInput, "xmas") == 0 || _stricmp(strInput, "x-mas") == 0 || _stricmp(strInput, "x-mass") == 0 || _stricmp(strInput, "xmass") == 0 || _stricmp(strInput, "x mass") == 0)
	{
		dt.SetDate(dt.GetYear(), 12, 25);
		bReturn = TRUE;
	}
	else if (_stricmp(strInput, "christmas eve") == 0 || _stricmp(strInput, "xmas eve") == 0 || _stricmp(strInput, "x-mas eve") == 0 || _stricmp(strInput, "x-mass eve") == 0 || _stricmp(strInput, "xmass eve") == 0 || _stricmp(strInput, "x mass eve") == 0)
	{
		dt.SetDate(dt.GetYear(), 12, 24);
		bReturn = TRUE;
	}
	else if (_stricmp(strInput, "new years") == 0 || _stricmp(strInput, "new years day") == 0)
	{
		dt.SetDate(dt.GetYear()+1, 1, 1);
		bReturn = TRUE;
	}
	else if (_stricmp(strInput, "new years eve") == 0 || _stricmp(strInput, "new years eve day") == 0)
	{
		dt.SetDate(dt.GetYear(), 12, 31);
		bReturn = TRUE;
	}
	else if (_stricmp(strInput, "halloween") == 0)
	{
		dt.SetDate(dt.GetYear(), 10, 31);
		bReturn = TRUE;
	}
	else if (_stricmp(strInput, "July 4th") == 0 || _stricmp(strInput, "July fourth") == 0 || _stricmp(strInput, "July forth") == 0 || _stricmp(strInput, "4th of July") == 0 || _stricmp(strInput, "fourth of July") == 0 || _stricmp(strInput, "forth of July") == 0 || _stricmp(strInput, "independence day") == 0)
	{
	...
	else if (_stricmp(strInput, "easter") == 0 || _stricmp(strInput, "easter sunday") == 0)
	{
		WORD wMonth = 0;
		WORD wDay = 0;
	...
	else if (_stricmp(strInput, "good friday") == 0)
	{
		WORD wMonth = 0;
		WORD wDay = 0;
	...
	else if (_stricmp(strInput, "ash wednesday") == 0)
	{
		WORD wMonth = 0;
		WORD wDay = 0;
	...
	else if (_stricmp(strInput, "veterans day") == 0 || _stricmp(strInput, "veteran day") == 0)
	{
	...
	else if (_stricmp(strInput, "memorial day") == 0)
	{
		// last monday in may
	...
	else if (_stricmp(strInput, "labor day") == 0)
	{
	...
	else if (_stricmp(strInput, "columbus day") == 0)
	{
	...
	else if (_stricmp(strInput, "thanksgiving") == 0 || _stricmp(strInput, "thanksgiving day") == 0)
	{
	...
	else if (_stricmp(strInput, "Washington's Birthday") == 0 || _stricmp(strInput, "Washingtons Birthday") == 0 || _stricmp(strInput, "Washington Birthday") == 0 || _stricmp(strInput, "presidents day") == 0 || _stricmp(strInput, "president's day") == 0 || _stricmp(strInput, "president day") == 0)
	{
	...
	else if (_stricmp(strInput, "NEXT YEAR") == 0 || _stricmp(strInput, "THIS NEXT YEAR") == 0)
	{
		dt = COleDateTime::GetCurrentTime();
	...
	else if (_stricmp(strInput, "PAST YEAR") == 0 || _stricmp(strInput, "THIS PAST YEAR") == 0 || _stricmp(strInput, "LAST YEAR") == 0 || _stricmp(strInput, "THIS LAST YEAR") == 0)
	{
		dt = COleDateTime::GetCurrentTime();
	...
	else if (_stricmp(strInput, "last sunday") == 0 || _stricmp(strInput, "this past sunday") == 0 || _stricmp(strInput, "past sunday") == 0)
	{
		int iSubDays = 0;
	...
	else if (_stricmp(strInput, "last monday") == 0 || _stricmp(strInput, "this past monday") == 0 || _stricmp(strInput, "past monday") == 0)
	{
		int iSubDays = 0;
	...
	else if (_stricmp(strInput, "last tuesday") == 0 || _stricmp(strInput, "this past tuesday") == 0 || _stricmp(strInput, "past tuesday") == 0)
	{
		int iSubDays = 0;
	...
	else if (_stricmp(strInput, "last wednesday") == 0 || _stricmp(strInput, "this past wednesday") == 0 || _stricmp(strInput, "past wednesday") == 0)
	{
		int iSubDays = 0;
	...
	else if (_stricmp(strInput, "last thursday") == 0 || _stricmp(strInput, "this past thursday") == 0 || _stricmp(strInput, "past thursday") == 0)
	{
		int iSubDays = 0;
	...
	else if (_stricmp(strInput, "last friday") == 0 || _stricmp(strInput, "this past friday") == 0 || _stricmp(strInput, "past friday") == 0)
	{
		int iSubDays = 0;
	...
	else if (_stricmp(strInput, "last saturday") == 0 || _stricmp(strInput, "this past saturday") == 0 || _stricmp(strInput, "past saturday") == 0)
	{
		int iSubDays = 0;
	...
	else if (_stricmp(strInput, "next sunday") == 0 || _stricmp(strInput, "sunday") == 0)
	{
		int iAddDays = 0;
	...
	else if (_stricmp(strInput, "next monday") == 0 || _stricmp(strInput, "monday") == 0)
	{
		int iAddDays = 0;
	...
	else if (_stricmp(strInput, "next tuesday") == 0 || _stricmp(strInput, "tuesday") == 0)
	{
		int iAddDays = 0;
	...
	else if (_stricmp(strInput, "next wednesday") == 0 || _stricmp(strInput, "wednesday") == 0)
	{
		int iAddDays = 0;
	...
	else if (_stricmp(strInput, "next thursday") == 0 || _stricmp(strInput, "thursday") == 0)
	{
		int iAddDays = 0;
	...
	else if (_stricmp(strInput, "next friday") == 0 || _stricmp(strInput, "friday") == 0)
	{
		int iAddDays = 0;
	...
	else if (_stricmp(strInput, "next saturday") == 0 || _stricmp(strInput, "saturday") == 0)
	{
		int iAddDays = 0;
	...
	else if ((_stricmp(strInput, "ONE DAY AGO") == 0 || _stricmp(strInput, "1 DAY AGO") == 0 || _stricmp(strInput, "A DAY AGO") == 0 || _stricmp(strInput, "DAY AGO") == 0) ||
			(_stricmp(strInput, "ONE DAYS AGO") == 0 || _stricmp(strInput, "1 DAYS AGO") == 0 || _stricmp(strInput, "A DAYS AGO") == 0 || _stricmp(strInput, "DAYS AGO") == 0))
	{
		dt -= 1;
		bReturn = TRUE;
	}
	else if ((_stricmp(strInput, "ONE DAY FROM NOW") == 0 || _stricmp(strInput, "1 DAY FROM NOW") == 0 || _stricmp(strInput, "A DAY FROM NOW") == 0 || _stricmp(strInput, "DAY FROM NOW") == 0) ||
		(_stricmp(strInput, "ONE DAYS FROM NOW") == 0 || _stricmp(strInput, "1 DAYS FROM NOW") == 0 || _stricmp(strInput, "A DAYS FROM NOW") == 0 || _stricmp(strInput, "DAYS FROM NOW") == 0))
	{
		dt += 1;
		bReturn = TRUE;
	}
	...
	else if ((_stricmp(strInput, "ONE MONTH AGO") == 0 || _stricmp(strInput, "1 MONTH AGO") == 0 || _stricmp(strInput, "A MONTH AGO") == 0 || _stricmp(strInput, "MONTH AGO") == 0) ||
			(_stricmp(strInput, "ONE MONTHS AGO") == 0 || _stricmp(strInput, "1 MONTHS AGO") == 0 || _stricmp(strInput, "A MONTHS AGO") == 0 || _stricmp(strInput, "MONTHS AGO") == 0))
	{
		COleDateTime dtNowTemp = COleDateTime::GetCurrentTime();
		dt = ComputeMonthsAgo(1, dtNowTemp);
		bReturn = TRUE;
	}
	else if ((_stricmp(strInput, "ONE MONTH FROM NOW") == 0 || _stricmp(strInput, "1 MONTH FROM NOW") == 0 || _stricmp(strInput, "A MONTH FROM NOW") == 0 || _stricmp(strInput, "MONTH FROM NOW") == 0) ||
		(_stricmp(strInput, "ONE MONTHS FROM NOW") == 0 || _stricmp(strInput, "1 MONTHS FROM NOW") == 0 || _stricmp(strInput, "A MONTHS FROM NOW") == 0 || _stricmp(strInput, "MONTHS FROM NOW") == 0))
	{
		COleDateTime dtNowTemp = COleDateTime::GetCurrentTime();
	...
	else if ((_stricmp(strInput, "ONE YEAR AGO") == 0 || _stricmp(strInput, "1 YEAR AGO") == 0 || _stricmp(strInput, "A YEAR AGO") == 0 || _stricmp(strInput, "YEAR AGO") == 0) ||
			(_stricmp(strInput, "ONE YEARS AGO") == 0 || _stricmp(strInput, "1 YEARS AGO") == 0 || _stricmp(strInput, "A YEARS AGO") == 0 || _stricmp(strInput, "YEARS AGO") == 0))
	{
		COleDateTime dtNowTemp = COleDateTime::GetCurrentTime();
		dt = ComputeMonthsAgo(12, dtNowTemp);
		bReturn = TRUE;
	}
	else if ((_stricmp(strInput, "ONE YEAR FROM NOW") == 0 || _stricmp(strInput, "1 YEAR FROM NOW") == 0 || _stricmp(strInput, "A YEAR FROM NOW") == 0 || _stricmp(strInput, "YEAR FROM NOW") == 0) ||
		(_stricmp(strInput, "ONE YEARS FROM NOW") == 0 || _stricmp(strInput, "1 YEARS FROM NOW") == 0 || _stricmp(strInput, "A YEARS FROM NOW") == 0 || _stricmp(strInput, "YEARS FROM NOW") == 0))
	{
		COleDateTime dtNowTemp = COleDateTime::GetCurrentTime();
...
BOOL COleDateTimeEx::EvaluateInputTextTime(LPCTSTR lpszInput, COleDateTime &dt)
{
	...
	if (_stricmp(strInput, "now") == 0)
	{
		bReturn = TRUE;
	}
	else if (_stricmp(strInput, "noon") == 0)
	{
		dt.ParseDateTime("12:00 PM");
		bReturn = TRUE;
	}
	else if (_stricmp(strInput, "midnight") == 0)
	{
...
BOOL COleDateTimeEx::FPSCompareString(LPCSTR lpszTest1, LPCSTR lpszTest2)
{
	...
	if (_stricmp(strComp1, strComp2) == 0)
		return TRUE;
...
BOOL COleDateTimeEx::IsLeapYear(int iYear)
{
	double tmp;
	tmp = (double) iYear;
	if (fmod(tmp, 4.00) == 0 && (fmod(tmp, 100.00) != 0 || fmod(tmp, 400) == 0))
		return TRUE;
...
BOOL COleDateTimeEx::ComputeDateFromWord(COleDateTimeEx &dt, CString &strInput, int iYear)
{
	...
	if (dtTemp.m_status == COleDateTime::valid)
	{
		...
		if (_stricmp(strInput, "christmas") == 0 || _stricmp(strInput, "xmas") == 0 || _stricmp(strInput, "x-mas") == 0 || _stricmp(strInput, "x-mass") == 0 || _stricmp(strInput, "xmass") == 0 || _stricmp(strInput, "x mass") == 0)
		{
...
BOOL COleDateTimeEx::GetBuiltInValue(int iType, int iYear)
{
	BOOL bReturn = TRUE;
...
BOOL COleDateTimeEx::GetDayInMonth(int iMonth, int iYear, int iWhichDay, int iDayOfWeek)
{
	BOOL bReturn = TRUE;

	switch(iWhichDay)
	{
	case OLEDATEEX_FIRST: {bReturn = GetDayOfWeekInMonth(iMonth, iYear, 1, iDayOfWeek); break;}
	case OLEDATEEX_SECOND: {bReturn = GetDayOfWeekInMonth(iMonth, iYear, 2, iDayOfWeek); break;}
	case OLEDATEEX_THIRD: {bReturn = GetDayOfWeekInMonth(iMonth, iYear, 3, iDayOfWeek); break;}
	case OLEDATEEX_FOURTH: {bReturn = GetDayOfWeekInMonth(iMonth, iYear, 4, iDayOfWeek); break;}
	case OLEDATEEX_LAST: {bReturn = GetLastDayOfWeekInMonth(iMonth, iYear, iDayOfWeek); break;}
	}

	return bReturn;
}

BOOL COleDateTimeEx::GetLastDayOfWeekInMonth(int iMonth, int iYear, int iDayType)
{
	BOOL bReturn = TRUE;
	BOOL bContinue = TRUE;
	COleDateTimeEx dtTemp;

	dtTemp.SetDate(iYear, iMonth, GetMaxDaysInMonth(iMonth, iYear));

	while (bContinue && dtTemp.GetStatus() == COleDateTime::valid)
	{
		if (dtTemp.IsDayType(iDayType))
		{
			(*this) = dtTemp;
			bContinue = FALSE;
		}
...
BOOL COleDateTimeEx::GetDayOfWeekInMonth(int iMonth, int iYear, int iCount, int iDayType)
{
	BOOL bReturn = TRUE;
	BOOL bContinue = TRUE;
	int iActualCount = 0;
...
CString COleDateTimeEx::GetMonthName(int iMonth)
{
	CString strReturn;
	...
	dt.SetDate(2000, iMonth, 1);
	strReturn = dt.Format("%B");

	return strReturn;
}

CString COleDateTimeEx::GetDayOfWeekName(int iDay)
{
	CString strReturn;
	...
	dt.SetDate(2000, 1, 1);
	while (dt.GetDayOfWeek() != iDay)
		dt += 1;

	strReturn = dt.Format("%A");

	return strReturn;
}

CString COleDateTimeEx::GetSystemShortDateFormat()
{
	CString strReturn = "%m/%d/%Y";

	HKEY hKey = NULL;
	
	int iReturn = ::RegOpenKeyEx(HKEY_CURRENT_USER, "Control Panel\\International", 0, KEY_QUERY_VALUE, &hKey);
	if (iReturn == ERROR_SUCCESS)
	{
		...
		memset(Data, 0, 200);
		iReturn = ::RegQueryValueEx(hKey, "sShortDate", NULL, &dwType, Data, &dwSize);
		if (iReturn == ERROR_SUCCESS && dwType == REG_SZ)
			strReturn = ConvertVBFormatToCFormat((char*)Data);
...
CString COleDateTimeEx::GetSystemLongDateFormat()
{
	CString strReturn = "%A %B %d, %Y";
	...
	if (iReturn == ERROR_SUCCESS)
	{
		...
		memset(Data, 0, 200);
		iReturn = ::RegQueryValueEx(hKey, "sLongDate", NULL, &dwType, Data, &dwSize);
		if (iReturn == ERROR_SUCCESS && dwType == REG_SZ)
			strReturn = ConvertVBFormatToCFormat((char*)Data);
...
CString COleDateTimeEx::ConvertVBFormatToCFormat(LPCTSTR lpszInput)
{
	CString strReturn;
	...
	memset(szTemp, 0, 200);
	strncpy_s(szTemp, lpszInput, 198);

	char* pszData = szTemp;

	while (*pszData)
	{
		if (!bInString && memcmp(pszData, "dddd", 4) == 0)
		{
			strReturn += "%A";			// ?
			pszData += 4;
		}
		else if (!bInString && memcmp(pszData, "MMMM", 4) == 0)
		{
			strReturn += "%B";			// ?
			pszData += 4;
		}
		else if (!bInString && memcmp(pszData, "yyyy", 4) == 0)
		{
			strReturn += "%Y";			// ?
			pszData += 4;
		}
		else if (!bInString && memcmp(pszData, "ddd", 3) == 0)
		{
			strReturn += "%a";			// ?
			pszData += 3;
		}
		else if (!bInString && memcmp(pszData, "MMM", 3) == 0)
		{
			strReturn += "%b";			// ?
			pszData += 3;
		}
		else if (!bInString && memcmp(pszData, "dd", 2) == 0)
		{
			strReturn += "%d";			// ?
			pszData += 2;
		}
		else if (!bInString && memcmp(pszData, "MM", 2) == 0)
		{
			strReturn += "%m";			// ?
			pszData += 2;
		}
		else if (!bInString && memcmp(pszData, "yy", 2) == 0)
		{
			strReturn += "%y";			// ?
			pszData += 2;
		}
		else if (!bInString && memcmp(pszData, "''", 2) == 0)
		{
			strReturn += "'";
			pszData += 2;
		}
		else if (!bInString && memcmp(pszData, "hh", 2) == 0)
		{
			strReturn += "%I";	
			pszData += 2;
		}
		...
		else if (!bInString && memcmp(pszData, "ss", 2) == 0)
		{
			strReturn += "%S";
			pszData += 2;
		}
		else if (!bInString && memcmp(pszData, "tt", 2) == 0)
		{
			strReturn += "%p";
			pszData += 2;
		}
		else if (!bInString && memcmp(pszData, "h", 1) == 0)
		{
			strReturn += "%#I";
			pszData += 1;
		}
		...
		else if (!bInString && memcmp(pszData, "m", 1) == 0)
		{
			strReturn += "%#M";	
			pszData += 1;
		}
		else if (!bInString && memcmp(pszData, "s", 1) == 0)
		{
			strReturn += "%#S";	
			pszData += 1;
		}
		else if (!bInString && memcmp(pszData, "t", 1) == 0)
		{
			strReturn += "%p";
			pszData += 1;
		}
		else if (!bInString && memcmp(pszData, "d", 1) == 0)
		{
			strReturn += "%#d";			// ?
			pszData += 1;
		}
		...
		else if (!bInString && memcmp(pszData, "y", 1) == 0)
		{
			strReturn += "%#y";			// ?
			pszData += 1;
		}
		else if (!bInString && memcmp(pszData, "'", 1) == 0)
		{
			bInString = !bInString;
			pszData += 1;
		}

...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
{
	...
	if (m_bDraw3DBar)		
	{
		...
		CRect BarBgRect( CPoint(m_recClient.left, m_recClient.bottom-m_nBarHeight), 
			CSize((int)m_recClient.right, m_nBarHeight) );
		...
		CRect BarRect(  CPoint(m_recClient.left, m_recClient.bottom-m_nBarHeight), 
			CSize((int)fWidth, m_nBarHeight) );
...
void CStaticCounter::Hide(){
	ModifyStyle(WS_VISIBLE,0);
	Update();
	UpdateWindow();
}

void CStaticCounter::Show(){
